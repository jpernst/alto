...
pub fn enable(capability: ALenum) {
    unsafe { ffi::alEnable(capability as i32); }
}

#[fixed_stack_segment]
pub fn disable(capability: ALenum) {
    unsafe { ffi::alDisable(capability as i32); }
}

#[fixed_stack_segment]
pub fn is_enabled(capability: ALenum) -> ALboolean {
    unsafe { ffi::alIsEnabled(capability as i32) }
}

#[fixed_stack_segment]
pub fn get_string(param: ALenum) -> ~str {
    unsafe { str::raw::from_c_str(ffi::alGetString(param as i32)) }
}

#[fixed_stack_segment]
pub fn get_booleanv(param: ALenum, data: &mut ALboolean) {
    unsafe { ffi::alGetBooleanv(param as i32, cast::transmute(data)); }
}

#[fixed_stack_segment]
pub fn get_integerv(param: ALenum, data: &mut ALint) {
    unsafe { ffi::alGetIntegerv(param as i32, cast::transmute(data)); }
}

#[fixed_stack_segment]
pub fn get_floatv(param: ALenum, data: &mut ALfloat) {
    unsafe { ffi::alGetFloatv(param as i32, cast::transmute(data)); }
}

#[fixed_stack_segment]
pub fn get_doublev(param: ALenum, data: &mut ALdouble) {
    unsafe { ffi::alGetDoublev(param as i32, cast::transmute(data)); }
}

#[fixed_stack_segment]
pub fn get_boolean(param: ALenum) -> ALboolean {
    unsafe { ffi::alGetBoolean(param as i32) }
}

#[fixed_stack_segment]
pub fn get_integer(param: ALenum) -> ALint {
    unsafe { ffi::alGetInteger(param as i32) }
}

#[fixed_stack_segment]
pub fn get_float(param: ALenum) -> ALfloat {
    unsafe { ffi::alGetFloat(param as i32) }
}

#[fixed_stack_segment]
pub fn get_double(param: ALenum) -> ALdouble {
    unsafe { ffi::alGetDouble(param as i32) }
}

#[fixed_stack_segment]
pub fn get_error() -> ALenum {
    unsafe { uint_to_ALenum(ffi::alGetError() as uint).unwrap() }
}
...
pub fn get_enum_value(ename: &str) -> ALenum {
    unsafe { uint_to_ALenum(ffi::alGetEnumValue( ename.with_c_str( |s| s)) as uint).unwrap() }
}


#[fixed_stack_segment]
pub fn listenerf(param: ALenum, value: ALfloat) {
    unsafe { ffi::alListenerf(param as i32, value); }
}

#[fixed_stack_segment]
pub fn listener3f(param: ALenum, value1: ALfloat, value2: ALfloat, value3: ALfloat) {
    unsafe { ffi::alListener3f(param as i32, value1, value2, value3); }
}
...
pub fn listeneri(param: ALenum, value: ALint) {
    unsafe { ffi::alListeneri(param as i32, value); }
}

#[fixed_stack_segment]
pub fn listener3i(param: ALenum, value1: ALint, value2: ALint, value3: ALint) {
    unsafe { ffi::alListener3i(param as i32, value1, value2, value3); }
}
...
pub fn get_listenerf(param: ALenum) -> ALfloat {
    let mut value = 0.0;
    unsafe { ffi::alGetListenerf(param as i32, cast::transmute(&value)) }
    value
}
...
pub fn get_listener3f(param: ALenum) -> (ALfloat, ALfloat, ALfloat) {
    ...
    let mut value2 = 0.0;
    let mut value3 = 0.0;
    unsafe { ffi::alGetListener3f(param as i32, cast::transmute(&value1),
...
pub fn get_listeneri(param: ALenum) -> ALint {
    let mut value = 0;
    unsafe { ffi::alGetListeneri(param as i32, cast::transmute(&value)) }
    value
}
...
pub fn get_listener3i(param: ALenum) -> (ALint, ALint, ALint) {
    ...
    let mut value2 = 0;
    let mut value3 = 0;
    unsafe { ffi::alGetListener3i(param as i32, cast::transmute(&value1),
                                        cast::transmute(&value2),
                                        cast::transmute(&value3)) }
    (value1, value2, value3)
}
...
pub fn sourcef(sid: ALuint, param: ALenum, value: ALfloat) {
    unsafe { ffi::alSourcef(sid, param as i32, value); }
}

#[fixed_stack_segment]
pub fn source3f(sid: ALuint, param: ALenum, value1: ALfloat, value2: ALfloat, value3: ALfloat) {
    unsafe { ffi::alSource3f(sid, param as i32, value1, value2, value3); }
}
...
pub fn sourcei(sid: ALuint, param: ALenum, value: ALint) {
    unsafe { ffi::alSourcei(sid, param as i32, value); }
}

#[fixed_stack_segment]
pub fn source3i(sid: ALuint, param: ALenum, value1: ALint, value2: ALint, value3: ALint) {
    unsafe { ffi::alSource3i(sid, param as i32, value1, value2, value3); }
}
...
pub fn get_sourcef(sid: ALuint, param: ALenum) -> ALfloat {
    let mut value = 0.0;
    unsafe { ffi::alGetSourcef(sid, param as i32, cast::transmute(&value)); }
    value
}
...
pub fn get_source3f(sid: ALuint, param: ALenum) -> (ALfloat, ALfloat, ALfloat) {
    ...
    let mut value2 = 0.0;
    let mut value3 = 0.0;
    unsafe { ffi::alGetSource3f(sid, param as i32, cast::transmute(&value1),
                                           cast::transmute(&value2),
                                           cast::transmute(&value3)); }
    (value1, value2, value3)
}
...
pub fn get_sourcei(sid: ALuint,  param: ALenum) -> ALint {
    let mut value = 0;
    unsafe { ffi::alGetSourcei(sid, param as i32, cast::transmute(&value)); }
    value
}
...
pub fn get_source3i(sid: ALuint, param: ALenum) -> (ALint, ALint, ALint) {
    ...
    let mut value2 = 0;
    let mut value3 = 0;
    unsafe { ffi::alGetSource3i(sid, param as i32, cast::transmute(&value1),
                                           cast::transmute(&value2),
                                           cast::transmute(&value3)); }
    (value1, value2, value3)
}
...
pub fn bufferf(bid: ALuint, param: ALenum, value: ALfloat) {
    unsafe { ffi::alBufferf(bid, param as i32, value); }
}

#[fixed_stack_segment]
pub fn buffer3f(bid: ALuint, param: ALenum, value1: ALfloat, value2: ALfloat, value3: ALfloat) {
    unsafe { ffi::alBuffer3f(bid, param as i32, value1, value2, value3); }
}
...
pub fn bufferi(bid: ALuint, param: ALenum, value: ALint) {
    unsafe { ffi::alBufferi(bid, param as i32, value); }
}

#[fixed_stack_segment]
pub fn buffer3i(bid: ALuint, param: ALenum, value1: ALint, value2: ALint, value3: ALint) {
    unsafe { ffi::alBuffer3i(bid, param as i32, value1, value2, value3); }
}
...
pub fn get_bufferf(sid: ALuint, param: ALenum) -> ALfloat {
    let mut value = 0.0;
    unsafe { ffi::alGetBufferf(sid, param as i32, cast::transmute(&value)); }
    value
}
...
pub fn get_buffer3f(sid: ALuint, param: ALenum) -> (ALfloat, ALfloat, ALfloat) {
    ...
    let mut value2 = 0.0;
    let mut value3 = 0.0;
    unsafe { ffi::alGetBuffer3f(sid, param as i32, cast::transmute(&value1),
                                           cast::transmute(&value2),
                                           cast::transmute(&value3)); }
    (value1, value2, value3)
}
...
pub fn get_bufferi(sid: ALuint,  param: ALenum) -> ALint {
    let mut value = 0;
    unsafe { ffi::alGetBufferi(sid, param as i32, cast::transmute(&value)); }
    value
}
...
pub fn get_buffer3i(sid: ALuint, param: ALenum) -> (ALint, ALint, ALint) {
    ...
    let mut value2 = 0;
    let mut value3 = 0;
    unsafe { ffi::alGetBuffer3i(sid, param as i32, cast::transmute(&value1),
                                           cast::transmute(&value2),
                                           cast::transmute(&value3)); }
    (value1, value2, value3)
}
