...
#![allow(dead_code,
         ...
         non_snake_case)]
pub const AL_INVALID: ::std::os::raw::c_char = -1;
pub const AL_NONE: ::std::os::raw::c_uchar = 0;
pub const AL_FALSE: ::std::os::raw::c_uchar = 0;
pub const AL_TRUE: ::std::os::raw::c_uchar = 1;
pub const AL_SOURCE_RELATIVE: ::std::os::raw::c_ushort = 514;
pub const AL_CONE_INNER_ANGLE: ::std::os::raw::c_ushort = 4097;
pub const AL_CONE_OUTER_ANGLE: ::std::os::raw::c_ushort = 4098;
pub const AL_PITCH: ::std::os::raw::c_ushort = 4099;
pub const AL_POSITION: ::std::os::raw::c_ushort = 4100;
pub const AL_DIRECTION: ::std::os::raw::c_ushort = 4101;
pub const AL_VELOCITY: ::std::os::raw::c_ushort = 4102;
pub const AL_LOOPING: ::std::os::raw::c_ushort = 4103;
pub const AL_BUFFER: ::std::os::raw::c_ushort = 4105;
pub const AL_GAIN: ::std::os::raw::c_ushort = 4106;
pub const AL_MIN_GAIN: ::std::os::raw::c_ushort = 4109;
pub const AL_MAX_GAIN: ::std::os::raw::c_ushort = 4110;
pub const AL_ORIENTATION: ::std::os::raw::c_ushort = 4111;
pub const AL_SOURCE_STATE: ::std::os::raw::c_ushort = 4112;
pub const AL_INITIAL: ::std::os::raw::c_ushort = 4113;
pub const AL_PLAYING: ::std::os::raw::c_ushort = 4114;
pub const AL_PAUSED: ::std::os::raw::c_ushort = 4115;
pub const AL_STOPPED: ::std::os::raw::c_ushort = 4116;
pub const AL_BUFFERS_QUEUED: ::std::os::raw::c_ushort = 4117;
pub const AL_BUFFERS_PROCESSED: ::std::os::raw::c_ushort = 4118;
pub const AL_REFERENCE_DISTANCE: ::std::os::raw::c_ushort = 4128;
pub const AL_ROLLOFF_FACTOR: ::std::os::raw::c_ushort = 4129;
pub const AL_CONE_OUTER_GAIN: ::std::os::raw::c_ushort = 4130;
pub const AL_MAX_DISTANCE: ::std::os::raw::c_ushort = 4131;
pub const AL_SEC_OFFSET: ::std::os::raw::c_ushort = 4132;
pub const AL_SAMPLE_OFFSET: ::std::os::raw::c_ushort = 4133;
pub const AL_BYTE_OFFSET: ::std::os::raw::c_ushort = 4134;
pub const AL_SOURCE_TYPE: ::std::os::raw::c_ushort = 4135;
pub const AL_STATIC: ::std::os::raw::c_ushort = 4136;
pub const AL_STREAMING: ::std::os::raw::c_ushort = 4137;
pub const AL_UNDETERMINED: ::std::os::raw::c_ushort = 4144;
pub const AL_FORMAT_MONO8: ::std::os::raw::c_ushort = 4352;
pub const AL_FORMAT_MONO16: ::std::os::raw::c_ushort = 4353;
pub const AL_FORMAT_STEREO8: ::std::os::raw::c_ushort = 4354;
pub const AL_FORMAT_STEREO16: ::std::os::raw::c_ushort = 4355;
pub const AL_FREQUENCY: ::std::os::raw::c_ushort = 8193;
pub const AL_BITS: ::std::os::raw::c_ushort = 8194;
pub const AL_CHANNELS: ::std::os::raw::c_ushort = 8195;
pub const AL_SIZE: ::std::os::raw::c_ushort = 8196;
pub const AL_UNUSED: ::std::os::raw::c_ushort = 8208;
pub const AL_PENDING: ::std::os::raw::c_ushort = 8209;
pub const AL_PROCESSED: ::std::os::raw::c_ushort = 8210;
pub const AL_NO_ERROR: ::std::os::raw::c_uchar = 0;
pub const AL_INVALID_NAME: ::std::os::raw::c_ushort = 40961;
pub const AL_INVALID_ENUM: ::std::os::raw::c_ushort = 40962;
pub const AL_INVALID_VALUE: ::std::os::raw::c_ushort = 40963;
pub const AL_INVALID_OPERATION: ::std::os::raw::c_ushort = 40964;
pub const AL_OUT_OF_MEMORY: ::std::os::raw::c_ushort = 40965;
pub const AL_VENDOR: ::std::os::raw::c_ushort = 45057;
pub const AL_VERSION: ::std::os::raw::c_ushort = 45058;
pub const AL_RENDERER: ::std::os::raw::c_ushort = 45059;
pub const AL_EXTENSIONS: ::std::os::raw::c_ushort = 45060;
pub const AL_DOPPLER_FACTOR: ::std::os::raw::c_ushort = 49152;
pub const AL_DOPPLER_VELOCITY: ::std::os::raw::c_ushort = 49153;
pub const AL_SPEED_OF_SOUND: ::std::os::raw::c_ushort = 49155;
pub const AL_DISTANCE_MODEL: ::std::os::raw::c_ushort = 53248;
pub const AL_INVERSE_DISTANCE: ::std::os::raw::c_ushort = 53249;
pub const AL_INVERSE_DISTANCE_CLAMPED: ::std::os::raw::c_ushort = 53250;
pub const AL_LINEAR_DISTANCE: ::std::os::raw::c_ushort = 53251;
pub const AL_LINEAR_DISTANCE_CLAMPED: ::std::os::raw::c_ushort = 53252;
pub const AL_EXPONENT_DISTANCE: ::std::os::raw::c_ushort = 53253;
pub const AL_EXPONENT_DISTANCE_CLAMPED: ::std::os::raw::c_ushort = 53254;
